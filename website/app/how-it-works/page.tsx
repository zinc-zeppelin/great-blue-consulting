              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <div className="grid md:grid-cols-4 gap-8">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">GPT-5 mini processes your specific pain points and matches them against proven automation patterns.</p>
                  </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <TechCard
                  ...
                  description="Part of OpenAI's revolutionary GPT-5 family launched in August 2025. GPT-5 mini delivers breakthrough performance with unified reasoning architecture, 45% fewer hallucinations than GPT-4, and real-time intelligent routing that optimizes speed vs. depth for your specific needs."
                  features={["272K token context window", "Unified reasoning architecture", "45% more accurate than GPT-4", "Automatic performance optimization"]}
                />
